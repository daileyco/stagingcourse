...
This video is from a MOOC (Massive Open Online Course) called ["Epidemics"](https://www.coursera.org/learn/epidemics), developed by several infectious disease faculty at Penn State and offered through the MOOC provider Coursera. Matt Ferrari, one of the course instructors, provides a very good explanation of the reproductive number concept.
...
This is another video from the ["Epidemics MOOC"](https://www.coursera.org/learn/epidemics), which discusses the shape of an individual outbreak curve and how it relates to the reproductive number.
